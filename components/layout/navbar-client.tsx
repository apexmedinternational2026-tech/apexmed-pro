  ...
  return (
    ...
    >
      ...
      {open && (
        ...
        // moving down closes it" bug. Reverted from a single vertical
        // column back to this 3-column layout — vertical needed a visible
        // internal scrollbar to fit all 10 services (max-h-[75vh]
        // overflow-y-auto), which read as cramped rather than professional.
